...
class ActivityFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $couture ->setEventdate(new \DateTime('01/30/2021 13:00:00'));
        ...
        $palet ->setEventdate(new \DateTime('02/02/2021 13:00:00'));
        ...
        $rencontre ->setEventdate(new \DateTime('01/27/2021 08:00:00'));
        ...
        $footing ->setEventdate(new \DateTime('02/16/2021 08:00:00'));
        ...
        $lithotherapie ->setEventdate(new \DateTime('01/29/2021 13:00:00'));
        ...
        $theatre ->setEventdate(new \DateTime('01/31/2021 20:00:00'));
        ...
        $rencontre2 ->setEventdate(new \DateTime('02/26/2021 20:00:00'));
