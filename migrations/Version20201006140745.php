 ...
 */
final class Version20201006140745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, user_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, eventdate DATETIME NOT NULL, created_at DATETIME NOT NULL, address VARCHAR(255) NOT NULL, INDEX IDX_AC74095A8BAC62AF (city_id), INDEX IDX_AC74095AA76ED395 (user_id), INDEX IDX_AC74095A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
